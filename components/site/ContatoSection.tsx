  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 min-h-[560px]">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 flex gap-8">
            {diferenciais.map(({ num, label }) => (
              <div key={label}>
                <span className="font-serif text-2xl md:text-3xl text-[#C6FF00] block">
                  {num}
                </span>
                <span className="text-[10px] uppercase tracking-widest text-white/50 mt-0.5 block">
                  {label}
                </span>
              </div>
            ))}
        ...
        >
          <span className="block text-[10px] uppercase tracking-[0.3em] text-[#C6FF00] mb-5">
            Contato
          </span>
          ...
          <p className="text-white/50 text-sm mb-8 max-w-sm">
            Resposta em até 1 hora — sem compromisso. Atendimento 100% online
            para todo o Brasil.
          </p>
          ...
          {status === "success" ? (
            ...
            >
              ...
              <p className="text-white/60 text-sm">
                Nilson vai entrar em contato em até 1 hora pelo WhatsApp ou
                e-mail.
              </p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col">
                  <label className="text-[9px] uppercase tracking-widest text-white/35 mb-2">
                    Nome Completo
                  </label>
                  <input
                    type="text"
