...
const tabelaIRPF = [
  { faixa: "Ate R$ 2.428,80", aliquota: "Isento", deducao: "—" },
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          >
            ...
            <p className="text-[10px] opacity-30 mt-2 leading-relaxed">
              Para rendas recebidas em 2026 (a declarar em 2027), nova isencao ate R$5.000/mes pela Lei 15.270/2025.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 p-6">
              <p className="text-sm opacity-70 mb-4">
                Nao deixe as multas acumularem. Regularize seu IRPF com
                seguranca e agilidade.
              </p>
              <a
                href={WA_LINK}
                target="_blank"
